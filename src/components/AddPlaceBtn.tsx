...
function AddPlaceBtn() {
    ...
    // Global Context
    const { setIsAddCategory, setIsGoogleAuth, selectedCategory } = getGlobalProvider();

    return (
        <section className="min-w-screen flex flex-col items-center justify-center gap-y-2 bg-white py-2">
